...
const config = {
  ...
  production: {
    API_BASE_URL: 'https://autojoin1-production.up.railway.app/',
    SOCKET_URL: 'https://autojoin1-production.up.railway.app/',
    MEDIA_BASE_URL: 'https://autojoin1-production.up.railway.app/media',
